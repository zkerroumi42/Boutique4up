...
public class Login extends javax.swing.JFrame {
    ...
    public void RedirectionToDashbord(){
        Dashbord DashbordFrame = new Dashbord();
        
        DashbordFrame.setVisible(true);
        DashbordFrame.pack();
        DashbordFrame.setLocationRelativeTo(null); 
        this.dispose();
        ...
        String url = "jdbc:mysql://localhost:3306/dbBoutique";
        ...
        try {
                ...
                // preparedStatement.setString(1, cnee);
